...
var checkTab = function checkTab() {
  var heading = document.querySelector('.swiper-slide-active').innerHTML;
  var line = document.querySelector('.tab__line');
...
var setTab = function setTab() {
  ...
  var tabButtons = document.querySelectorAll('.tumblr__button');
