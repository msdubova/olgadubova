...
var btn = document.querySelector('.menu__button');
var block = document.querySelector('.menu__block'); // let closeBtn = block.querySelector('.menu__close');
...
var onClickBtn = function onClickBtn(evt) {
...
btn.addEventListener('click', onClickBtn); // closeBtn.addEventListener('click', onCloseBtnClick);
...
function shuffleList() {
  ...
  items.forEach(function (item) {
    list.appendChild(item);
    item.style.transform = "translateY(".concat(Math.random() * -200, "px)");
    item.style.opacity = 0;
...
window.onload = shuffleList;
var shuffle = document.querySelector('.skills__shuffle');
shuffle.addEventListener('click', function () {
  shuffleList();
}); // function shuffleList() {
//   const list = document.querySelector('.skills');
