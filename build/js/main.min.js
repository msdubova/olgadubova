...
var block = document.querySelector('.menu__block');
var WIDTH = 770;
var isOpen = false;
...
function setColorMode() {
  ...
  var buttonNight = document.querySelector('.toggle-switch');
...
function shuffleList() {
  ...
  items.forEach(function (item) {
    ...
    item.style.opacity = 0; // if (Math.random() < 0.5) {
...
function setSwitchState() {
  var switchInput = document.querySelector('.toggle-switch');
