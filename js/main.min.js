...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var o=n(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),s=n(/*! ./modules/modals/init-modals */"./js/modules/modals/init-modals.js");window.addEventListener("DOMContentLoaded",(function(){Object(o.iosVhFix)(),window.addEventListener("load",(function(){Object(s.initModals)()}))}));var i=document.querySelector(".menu__button"),l=document.querySelector(".menu__block"),c=l.querySelector(".menu__close"),a=!1,r=function(){l.classList.remove("menu__block--active"),a=!1};i.addEventListener("click",(function(e){window.innerWidth<770&&(e.preventDefault(),a?r():(l.classList.add("menu__block--active"),a=!0))})),c.addEventListener("click",(function(){r()}))},"./js/modules/modals/init-modals.js":
/*!******************************************!*\
